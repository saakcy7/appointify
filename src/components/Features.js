        ...
        <div className="features">
            ...
            <h1>
                Our Features
                      ...
                      <FeatureData className="first-fea" heading="Book anywhere" text="Clients can schedule, or cancel appointments with ease, whether you're at home or on the go.Appointify offers you the flexibility to manage your appointments effortlessly, keeping you in control of your time no matter where you are."
                      img1={pic1}
                      img2={pic4}/>
...
Encourage users to create profiles and save preferences for future bookings"
                      img1={pic3}
                      img2={pic2}/>
